        ...
        >
            ...
            <div className="flex relative">
                ...
                }
                {
                    toggleMenu && (
                        <ul
                            className="z-10 fixed top-0 -right-2 p-3 w-[70vh] h-screen shadow-2xl md:hidden list-none flex flex-col justify-start items-end rounded-md blue-glassmorphism text-white animate-slide-in"
                        >
